...
namespace gdb
{
    ...
    public:
        ...
        enum
        {
            RuleRoot = 0,
            RuleSections = 1,
            RuleMaterialSection = 2,
            RuleMaterialNameList = 3,
            RuleMaterialName = 4,
            RuleScaleSection = 5,
            RuleVertexSection = 6,
            RuleVertexList = 7,
            RuleVertexDefPosition = 8,
            RuleVertexDefPositionUv = 9,
            RuleVertexDefPositionUvColor = 10,
            RuleVertexDefPositionUvNormal = 11,
            RuleVertexPosition = 12,
            RuleVertexUv = 13,
            RuleVertexColor = 14,
            RuleVertexNormal = 15,
            RuleFaceSection = 16,
