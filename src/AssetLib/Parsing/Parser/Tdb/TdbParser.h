...
namespace tdb
{
    ...
    public:
        ...
        enum
        {
            ...
            RuleTexture = 2,
            RuleTextureName = 3,
            RuleTextureProperty = 4,
            RuleColorTextureProperty = 5,
            RuleColorTexturePropertyKeyword = 6,
            RuleIntTextureProperty = 7,
            RuleIntTexturePropertyKeyword = 8,
            RuleSingleValueKeywords = 9,
