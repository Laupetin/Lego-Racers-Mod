...
namespace mdb
{
    ...
    public:
        ...
        enum
        {
            ...
            RuleMaterial = 2,
            RuleMaterialName = 3,
            RuleMaterialProperty = 4,
            RuleColorMaterialProperty = 5,
            RuleColorMaterialPropertyKeyword = 6,
            RuleTextMaterialProperty = 7,
            RuleTextMaterialPropertyKeyword = 8,
            RuleUint8MaterialProperty = 9,
            RuleUint8MaterialPropertyKeyword = 10,
            RuleIntMaterialProperty = 11,
            RuleIntMaterialPropertyKeyword = 12,
            RuleSingleValueKeywords = 13,
            RuleKeyword2F = 14,
            RuleKeyword2FSubtoken = 15,
            RuleKeyword38 = 16,
            RuleKeyword38Subtoken = 17,
