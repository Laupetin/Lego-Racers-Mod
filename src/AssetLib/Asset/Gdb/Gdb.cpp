...
std::size_t std::hash<Vec2>::operator()(const Vec2& vec) const noexcept
{
...
std::size_t std::hash<Color4>::operator()(const Color4& clr) const noexcept
{
...
bool gdb::operator==(const Vertex& lhs, const Vertex& rhs)
{
