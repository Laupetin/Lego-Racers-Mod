...
void UnitProcessorInputsAndOutputs::AddOutput(std::filesystem::path file, JamFilePath jamPath)
{
...
UnitProcessorResult::UnitProcessorResult(std::filesystem::path file, JamFilePath jamPath)
